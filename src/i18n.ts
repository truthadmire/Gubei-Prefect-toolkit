...
const EN_COPY = {
  ...
  importApply: "Apply code",
  importApplying: "Applying…",
  importClear: "Clear imported history",
  importCleared: "Imported assignment history cleared",
  historyTitle: "Local History",
  historySearch: "Search history",
  historyFilter: "History source",
  historyAll: "All",
  historyShared: "Shared",
  historyDevice: "This device",
  historyLoadMore: "Load more",
  historyLoading: "Loading…",
  historyEmpty: "No matching history",
  historyLocal: "On this device",
  historyQueued: "Waiting to share",
  historySharedStatus: "Shared publicly",
  historyFailed: "Retry pending",
  historySelect: "Select generation history",
  historyUse: "Load",
  historyClear: "Clear this device",
...
const ZH_COPY: AppCopy = {
  ...
  historyLocal: "仅保存在本机",
  historyQueued: "等待公开同步",
  historySharedStatus: "已公开共享",
  historyFailed: "等待重试",
  historySelect: "选择历史记录",
  historyUse: "载入",
  historyClear: "清除此设备记录",
